...
public class Const {
	...
	/** The Constant MAJOR_STAR_EMPEROR. */
	...
	/** The Constant MAJOR_STAR_RECREATION. */
	...
	/** The Constant MINOR_STAR_EMPTY_GROUND. */
	public static final String MINOR_STAR_EMPTY_GROUND = "地空";

	/** The Constant MINOR_STAR_GROUND_DISASTER. */
	public static final String MINOR_STAR_GROUND_DISASTER = "地劫";

	/** The Constant MINOR_STAR_FIRE_BURN. */
	...
	/** The Constant MINI_STAR_SKY_HAPPINESS. */
	...
	/** The Constant MINI_STAR_SKY_LOST. */
	...
	/** The Constant MINI_STAR_INDEPENDENT. */
	public static final String MINI_STAR_INDEPENDENT = "孤辰";

	/** The Constant MINI_STAR_SINGLE. */
	public static final String MINI_STAR_SINGLE = "寡宿";

	/** The Constant MINI_STAR_RESOLVE. */
	public static final String MINI_STAR_RESOLVE = "解神";

	/** The Constant MINI_STAR_BROKEN. */
	public static final String MINI_STAR_BROKEN = "破碎";

	/** The Constant MINI_STAR_BIG_LOST. */
	public static final String MINI_STAR_BIG_LOST = "大耗";

	/** The Constant MINI_STAR_LITTLE_DISASTER. */
	public static final String MINI_STAR_LITTLE_DISASTER = "劫煞";

	/** The Constant MINI_STAR_BAD_ROMANCE. */
	public static final String MINI_STAR_BAD_ROMANCE = "咸池";

	/** The Constant MINI_STAR_MOON_ETHIC. */
	public static final String MINI_STAR_MOON_ETHIC = "月德";

	/** The Constant MINI_STAR_GENIUS. */
	...
	/** The Constant MINI_STAR_LAZY_SKY. */
	public static final String MINI_STAR_LAZY_SKY = "旬空";

	/** The Constant MINI_STAR_LAZY_SKY2. */
	public static final String MINI_STAR_LAZY_SKY2 = "旬空2";

	/** The Constant MINI_STAR_INTERRUPT_SKY. */
	public static final String MINI_STAR_INTERRUPT_SKY = "截空";

	/** The Constant MINI_STAR_INTERRUPT_SKY2. */
	...
	/** The Constant MINI_STAR_SKY_ROMANTIC. */
	public static final String MINI_STAR_SKY_ROMANTIC = "天姚";

	/** The Constant MINI_STAR_SKY_WITCH. */
	public static final String MINI_STAR_SKY_WITCH = "天巫";

	/** The Constant MINI_STAR_SKY_MOON. */
	...
	/** The Constant MINI_STAR_WRONG_MOUTH2. */
	public static final String MINI_STAR_WRONG_MOUTH2 = "蜚廉2";

	/** The Constant MINI_STAR_DOCTOR. */
	public static final String MINI_STAR_DOCTOR = "博士";

	/** The Constant MINI_STAR_STRENGTH. */
	...
	/** The Constant MINI_STAR_JOY_GOD. */
	public static final String MINI_STAR_JOY_GOD = "喜神";

	/** The Constant MINI_STAR_SICK_TICKET. */
	public static final String MINI_STAR_SICK_TICKET = "病符";

	/** The Constant MINI_STAR_BIG_LOST2. */
	public static final String MINI_STAR_BIG_LOST2 = "大耗2";

	/** The Constant MINI_STAR_ARMY_TRAP. */
	public static final String MINI_STAR_ARMY_TRAP = "伏兵";

	/** The Constant MINI_STAR_GOVERNMENT. */
	public static final String MINI_STAR_GOVERNMENT = "官府";

	/** The Constant MINI_STAR_THREE_TABLE. */
	public static final String MINI_STAR_THREE_TABLE = "三台";

	/** The Constant MINI_STAR_EIGHT_SEAT. */
	public static final String MINI_STAR_EIGHT_SEAT = "八座";

	/** The Constant MINI_STAR_HOLY_LIGHT. */
	public static final String MINI_STAR_HOLY_LIGHT = "恩光";

	/** The Constant MINI_STAR_SKY_PRECIOUS. */
	...
	/** The Constant MINI_STAR_GOVERNMENT_TICKET. */
	public static final String MINI_STAR_GOVERNMENT_TICKET = "官符";

	/** The Constant MINI_STAR_SMALL_LOST2. */
	...
	/** The Constant MINI_STAR_FATHER_GIFT. */
	public static final String MINI_STAR_FATHER_GIFT = "天德";

	/** The Constant MINI_STAR_PARENT_DIE. */
	public static final String MINI_STAR_PARENT_DIE = "弔客";

	/** The Constant MINI_STAR_SICK_TICKET2. */
	public static final String MINI_STAR_SICK_TICKET2 = "病符2";

	/** The Constant MINI_STAR_ANGEL. */
	...
	/** The Constant MINI_STAR_CLIMB_HORSE. */
	...
	/** The Constant MINI_STAR_BETRAY. */
	public static final String MINI_STAR_BETRAY = "指背";

	/** The Constant MINI_STAR_BAD_ROMANCE2. */
	public static final String MINI_STAR_BAD_ROMANCE2 = "咸池2";

	/** The Constant MINI_STAR_MOON_MONSTER. */
	public static final String MINI_STAR_MOON_MONSTER = "月煞";

	/** The Constant MINI_STAR_DEAD_GOD. */
	public static final String MINI_STAR_DEAD_GOD = "亡神";

	/** The Constant MEET_DISTANT. */
	public static final int MEET_DISTANT = 4;

	/** The Constant OPPOSITE_DISTANT. */
	public static final int OPPOSITE_DISTANT = 6;

	/** The Constant NUM_CELLS. */
	public static final int NUM_CELLS = 12;

	/** The Constant SKY_NUM. */
	public static final int SKY_NUM = 10;

	/** The Constant GROUND_NUM. */
	public static final int GROUND_NUM = 12;

	/** The Constant SKY_0. */
	public static final String SKY_0 = "甲";

	/** The Constant SKY_1. */
	public static final String SKY_1 = "乙";

	/** The Constant SKY_2. */
	public static final String SKY_2 = "丙";

	/** The Constant SKY_3. */
	public static final String SKY_3 = "丁";

	/** The Constant SKY_4. */
	public static final String SKY_4 = "戊";

	/** The Constant SKY_5. */
	public static final String SKY_5 = "己";

	/** The Constant SKY_6. */
	public static final String SKY_6 = "庚";

	/** The Constant SKY_7. */
	public static final String SKY_7 = "辛";

	/** The Constant SKY_8. */
	public static final String SKY_8 = "壬";

	/** The Constant SKY_9. */
	public static final String SKY_9 = "癸";

	/** The Constant GROUND_0. */
	public static final String GROUND_0 = "子";

	/** The Constant GROUND_1. */
	public static final String GROUND_1 = "丑";

	/** The Constant GROUND_2. */
	public static final String GROUND_2 = "寅";

	/** The Constant GROUND_3. */
	public static final String GROUND_3 = "卯";

	/** The Constant GROUND_4. */
	public static final String GROUND_4 = "辰";

	/** The Constant GROUND_5. */
	public static final String GROUND_5 = "巳";

	/** The Constant GROUND_6. */
	public static final String GROUND_6 = "午";

	/** The Constant GROUND_7. */
	public static final String GROUND_7 = "未";

	/** The Constant GROUND_8. */
	public static final String GROUND_8 = "申";

	/** The Constant GROUND_9. */
	public static final String GROUND_9 = "酉";

	/** The Constant GROUND_10. */
	public static final String GROUND_10 = "戌";

	/** The Constant GROUND_11. */
	...
	/** The Constant PERSIST12_5. */
	public static final String PERSIST12_5 = "衰";

	/** The Constant PERSIST12_6. */
	public static final String PERSIST12_6 = "病";

	/** The Constant PERSIST12_7. */
	public static final String PERSIST12_7 = "死";

	/** The Constant PERSIST12_8. */
	public static final String PERSIST12_8 = "墓";

	/** The Constant PERSIST12_9. */
	public static final String PERSIST12_9 = "絕";

	/** The Constant PERSIST12_10. */
